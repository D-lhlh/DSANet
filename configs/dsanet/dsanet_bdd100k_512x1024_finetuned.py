...
crop_size = (512, 1024)
'''Unofficial, please do not use it'''
# class_weight = [0.0452, 0.4772, 0.0732, 2.0284, 0.942, 1.0504, 5.4007, 2.8605, 0.0735,
#                 0.9422, 0.0561, 3.867, 47.0585, 0.1197, 1.0, 1.7467, 70.7103, 40.3139,
#                 0.0517
# ]
class_weight = None
ckp = '/root/autodl-tmp/DSANet-main/configs/dsanet/city_756.pth'
